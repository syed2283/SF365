...
{
    private MessageNameEnum create;
    private string v1;
    private StageEnum preValidation;
    private ExecutionModeEnum synchronous;
    private string v2;
    private int v3;
    private IsolationModeEnum sandbox;
    ...
    public CrmPluginRegistrationAttribute(MessageNameEnum create, string v1, StageEnum preValidation, ExecutionModeEnum synchronous, string v2, int v3, IsolationModeEnum sandbox, string Image1Name, ImageTypeEnum Image1Type, string Image1Attributes)
    {
        this.create = create;
        this.v1 = v1;
        ...
        this.Image1Attributes = Image1Attributes;
    }
